 ...
 * @author asgha
 */
public class Addfee_page extends javax.swing.JFrame {
    ...
    private void setamnt(float amnt) {
        try {
            System.out.println(amnt);
            txtamount.setText(result_set.getString("cost"));
            ...
            txttotalwords.setText(NumberToWordsConverter.convert((int) total));
        } catch (SQLException e) {
        }
    }

    private void course_db() {
        try {
            int stu_id = Integer.parseInt(rollnotxt.getText());
            prepared_statement = Sqlconnection.prepareStatement("select course,Firstname,Lastname from student_addmision where Student_id=?");
            prepared_statement.setInt(1, stu_id);
            result_set = prepared_statement.executeQuery();
            result_set.next();

            String course = result_set.getString("course");
            String fname = result_set.getString("Firstname");
            String lname = result_set.getString("Lastname");
            String recever_nm = fname + " " + lname;
            txtrecieved.setText(recever_nm);
            couresedb.setText(course);

            prepared_statement = Sqlconnection.prepareStatement("select cost from courses where course_name=?");
            prepared_statement.setString(1, course);
            result_set = prepared_statement.executeQuery();
            result_set.next();

            float amnt = Float.parseFloat(result_set.getString("cost"));
...
//            }
    ...
    public boolean insertdata() {
        ...
        String couresname = couresedb.getText();
...
//        Date date = txtdate.getDate();
        ...
        try {
            //            pst = sqlConn.prepareStatement("select names from course");
            prepared_statement = Sqlconnection.prepareStatement("insert into fees_data(recieptno, studentname, "
            ...
            prepared_statement.setString(17, year1);
            prepared_statement.setString(18, year2);
//                       prepared_statement.executeUpdate();
    ...
    private void initComponents() {
        ...
        couresedb = new javax.swing.JTextField();
        ...
        panelparent.add(chequelbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 130, -1, -1));

        ddnolbl.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ddnolbl.setText("ddno :");
        panelparent.add(ddnolbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 110, -1, -1));

        jLabel14.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel14.setText("Date:");
        panelparent.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 50, 50, -1));
        ...
        jLabel13.setText("The Following Paymention the Institute Office for Year");
        panelchild.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, 440, 30));

        jLabel15.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel15.setText("Amount (Rs)");
        panelchild.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 170, -1, -1));

        jLabel18.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel18.setText("TO");
        panelchild.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 70, 30, 30));
        panelchild.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, 1000, 20));
        panelchild.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 1000, 10));

        jLabel20.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel20.setText("Sr. No");
        panelchild.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 170, -1, -1));
        ...
        panelchild.add(txtrecieved, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 20, 260, 30));
        ...
        panelchild.add(txtamount, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 210, 130, 30));
        ...
        panelchild.add(txtcgst, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 250, 130, 30));
        panelchild.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 330, 170, 10));
        ...
        panelchild.add(txtsgst, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 290, 130, 30));
        ...
        panelchild.add(txttotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 340, 130, 30));

        jLabel22.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel22.setText("Taxes");
        panelchild.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 170, -1, -1));

        jLabel23.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel23.setText("Fees");
        panelchild.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 210, 70, -1));

        jLabel24.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel24.setText("SGST 9% ");
        panelchild.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 290, -1, -1));

        jLabel25.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel25.setText("Recever Signature");
        panelchild.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 400, -1, 30));
        ...
        panelchild.add(txttotalwords, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 330, 340, 60));
        panelchild.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 380, 180, 30));

        jLabel26.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel26.setText("Total In Words:");
        panelchild.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 330, -1, 30));

        txtremarks.setColumns(20);
        txtremarks.setRows(5);
        jScrollPane1.setViewportView(txtremarks);

        panelchild.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 410, 340, 70));
        ...
        panelchild.add(printbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 440, 100, 30));

        txtyear1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        panelchild.add(txtyear1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 70, 80, 30));

        jLabel27.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel27.setText("Recieved From:");
        panelchild.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 22, -1, 30));

        jLabel28.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel28.setText("Course:");
        panelchild.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 112, 90, 30));
        ...
        panelchild.add(txtyear2, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 70, 80, 30));

        couresedb.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        couresedb.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                couresedbActionPerformed(evt);
            }
        });
        panelchild.add(couresedb, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 110, 260, 30));

        jLabel29.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel29.setText("CGST 9%");
        panelchild.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 250, -1, -1));

        panelparent.add(panelchild, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 210, 1320, 730));

        txtbank.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        txtbank.setText(" ");
        panelparent.add(txtbank, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 160, 160, -1));

        jLabel16.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel16.setText("GSIN :");
        panelparent.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 100, -1, -1));
        ...
        panelparent.add(banklbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, -1, -1));
        panelparent.add(txtdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 50, 130, 30));

        rollnotxt.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        rollnotxt.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                rollnotxtMouseClicked(evt);
            }
        });
        ...
        panelparent.add(rollnotxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 150, 140, 30));

        jLabel19.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel19.setText("Roll No:");
        panelparent.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 150, 90, 30));

        getContentPane().add(panelparent, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 0, -1, 940));
        ...
        panelsidebar.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 520, 330, 70));
        ...
        panelsidebar.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 620, 330, 70));
        ...
        panelsidebar.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 50, 330, 70));
        ...
        panelsidebar.add(jPanel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 140, 330, 70));
        ...
        panelsidebar.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 230, 330, 70));
        ...
        panelsidebar.add(jPanel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 330, 330, 70));
        ...
        panelsidebar.add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 420, 330, 70));

        getContentPane().add(panelsidebar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 510, 1040));

        setSize(new java.awt.Dimension(1815, 946));
    ...
    private void printbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printbtnActionPerformed
        ...
        if (val == true) {
            ...
            if (result == true) {
                ...
                JOptionPane.showMessageDialog(null, " datafial");
            }
        }
    ...
    private void couresedbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_couresedbActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_couresedbActionPerformed

    private void rollnotxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rollnotxtMouseClicked
        // TODO add your handling code here:
        course_db();

    }//GEN-LAST:event_rollnotxtMouseClicked
    ...
    private javax.swing.JTextField couresedb;
